...
class CustomDialog extends StatefulWidget {
  ...
  CustomDialog({
    ...
    total = itemList.isEmpty ? 0 : itemList.map((e) => e.calculatePrice()).toList().reduce((v,e) => v + e);
  }
    ...
    void removeItem(int index) {
      if(widget.itemList.length == 1) {
        ...
        setState(() {
          ...
          widget.total = widget.itemList.map((e) => e.calculatePrice()).toList().reduce((v,e) => v + e);
        });
      }
   }
