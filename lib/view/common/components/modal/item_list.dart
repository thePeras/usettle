...
class ModalItemListState extends State<ModalItemList> {
  ...
  Widget build(BuildContext context) {
    return widget.itemList.isNotEmpty ? Container(
        ...
        child: Padding(
          ...
          child: Column(
            children: List.generate(widget.itemList.length, (i) => buildEntry(widget.itemList[i], i))
          ),
        )
    ) : Column(
      children : [Text("Não há mais itens associados")]
    );
  }
